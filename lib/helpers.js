...
function validateConstructor(init) {
  ...
  if (!init.athena)
    throw new TypeError("Athena object not present or incorrect in the constructor");
  if (!init.s3)
    throw new TypeError("S3 object not present or incorrect in the constructor");
    if (!init.s3Bucket)
    throw new TypeError("S3 bucket and prefix not present or incorrect in the constructor");
}
